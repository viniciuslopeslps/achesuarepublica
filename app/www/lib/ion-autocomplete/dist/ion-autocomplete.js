        ...
        return {
            ...
            controller: ['$attrs', '$timeout', '$scope', function ($attrs, $timeout, $scope) {
                ...
                $timeout(function () {
                    ...
                    controller.cancelLabel = valueOrDefault(controller.cancelLabel, 'Fechar');
                    controller.selectItemsLabel = valueOrDefault(controller.selectItemsLabel, "Escolha um item...");
                    controller.selectedItemsLabel = valueOrDefault(controller.selectedItemsLabel, $interpolate("Escolha {{maxSelectedItems ? ' (max. ' + maxSelectedItems + ')' : '' }} item:")(controller));
                });
