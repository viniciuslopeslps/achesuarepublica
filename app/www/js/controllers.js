angular.module('starter.controllers', ['starter.services', 'ion-autocomplete'])
  ...
  .controller('loginCtrl', function ($scope, $state, $http, alertService, session, ip, redirect) {
    ...
    $scope.login = function (data) {
      if (data === undefined || data['email'] === undefined || data['password'] === undefined) {
        ...
        $http.get(ip + '/login/' + email + '/' + hash).success(function (response) {
          ...
          if (obj.user == null) {
            ...
            session.saveData(obj.user.id, obj.user.name, obj.user.email, obj.user.phone,
              obj.user.password, obj.user.admin);
    ...
    $scope.resetPassword = function (data) {
      if (data === undefined || data['email'] === undefined) {
        ...
        $http.post(ip + '/resetPassword', data).success(function (response) {
          var dado = angular.toJson(response);
          var obj = jQuery.parseJSON(dado);
          if (obj.answer == null) {
  ...
  .controller('selectedRoomCtrl', function ($scope, $state, $http, alertService, ip, $ionicModal) {
    ...
    $scope.sendContactEmail = function (data) {
      if (data === undefined || data['subject'] === undefined || data['message'] === undefined) {
        ...
        $http.post(ip + '/sendRoomInterested', data).success(function (response) {
          var dado = angular.toJson(response);
          var obj = jQuery.parseJSON(dado);
  ...
  .controller('profileCtrl', function ($scope, $state, $ionicPopup, $http, alertService, ip, redirect) {
    ...
    $scope.createUser = function (data) {
      if (data === undefined || data['email'] === undefined || data['password'] === undefined
        ...
        //cria Objeto js para envio de método POST
        var data = {
          "email": $scope.data.email,
          "password": hash,
        ...
        $http.post(ip + '/createUser', data).success(function (response) {
          var dado = angular.toJson(response);
          var obj = jQuery.parseJSON(dado);
    ...
    $scope.updateUser = function (data) {
      ...
      //cria Objeto js para envio de método PUT
      var data = {
        "email": email,
        "name": name,
        "phone": phone,
      ...
      $http.put(ip + '/updateUser', data).success(function (response) {
        var dado = angular.toJson(response);
        var obj = jQuery.parseJSON(dado);
    ...
    $scope.deleteUser = function (data) {
      ...
      confirmPopup.then(function (res) {
        if (res) {
          ...
          $http.delete(ip + '/deleteUser/' + id).success(function (response) {
            var dado = angular.toJson(response);
            var obj = jQuery.parseJSON(dado);
    ...
    $scope.passwordUpdate = function (data) {
      if (data === undefined || data['password'] === undefined || data['passwordConfirm'] === undefined
        ...
        $http.put(ip + '/updatePassword', data).success(function (response) {
          var dado = angular.toJson(response);
          var obj = jQuery.parseJSON(dado);
  ...
  .controller('locationCtrl', function ($scope, $state, $http, $ionicPopup, alertService, ip, session, location, redirect) {
    ...
    $scope.createNewLocation = function (data) {
      if (data === undefined || data['city'] === undefined || data['state'] === undefined) {
        ...
        var extra_locat = $scope.data.address;
        var id_usu = window.localStorage['id_usu'];

        var data = {
          "city_locat": $scope.data.city,
          "state_locat": $scope.data.state,
          "extra_locat": $scope.data.address,
          "id_usu": id_usu
        };
        $http.post(ip + '/createLocation', data).success(function (response) {
          location.saveData(undefined, data.city_locat, data.extra_locat, data.state_locat);
      ...
      for (i = 0; i < locationsAnswer.length; i++) {
        for (a = 0; a < locationsAnswer[0].length; a++) {
          if (locationsAnswer[i][a]["key_locat"] == objRespose) {
            ...
            $scope.address = locationsAnswer[i][a]["extra_locat"];
    ...
    $scope.updateLocalization = function (data) {
      ...
      $http.put(ip + '/updateLocation', data).success(function (response) {
    ...
    $scope.deleteLocation = function (data) {
      ...
      confirmPopup.then(function (res) {
        if (res) {
          ...
          $http.delete(ip + '/deleteLocation/' + id_locat).success(function (response) {
            alertService.alertPopup('Deletado com sucesso!', 'Registro deletado com sucesso!');
            location.clearAll();
            delete $scope.data;
            delete $scope.city;
  ...
  .controller('universityCtrl', function ($scope, $state, $http, $ionicPopup, $ionicHistory, alertService, ip, session, location, university, redirect) {
    ...
    $scope.getLocations = function () {
      $http.get(ip + '/getLocationKeys/').success(function (response) {
        var dado = angular.toJson(response);
        var obj = jQuery.parseJSON(dado);
    ...
    $scope.createUniversity = function (data) {
      if (data === undefined || data['name'] === undefined || data['locationKey'] === undefined) {
        ...
        var data = {
          "name": $scope.data.name,
          "key_locat": $scope.data.locationKey,
          "id_usu": idUsu
        };

        $http.post(ip + '/createUniversity', data).success(function (response) {
          alertService.alertPopup('Nova localização!', 'Registro de localização inserida com sucesso!');
    ...
    $scope.getUniversities = function () {
      ...
      $http.get(ip + '/getUniversitiesById/' + idUsu).success(function (response) {
        var dado = angular.toJson(response);
        var obj = jQuery.parseJSON(dado);
    ...
    $scope.updateUniversity = function (data) {
      ...
      var data = {
        "name": name,
        "key_locat": keyLocatUni,
        "id_uni": idUni,
        "id_usu": idUsu
      };

      $http.put(ip + '/updateUniversity', data).success(function (response) {
        alertService.alertPopup('Alterado!', 'Registro de localização alterado com sucesso!');
        delete $scope.name;
        delete $scope.locationKey;
        delete $scope.data;
    ...
    $scope.deleteUniversity = function (data) {
      ...
      confirmPopup.then(function (res) {
        if (res) {
          var idUsu = window.localStorage['id_usu'];
          var keyUni = $scope.data.keyUni;
          $http.delete(ip + '/deleteUniversity/' + keyUni + '/' + idUsu).success(function (response) {
  ...
  .controller('republicCtrl', function ($scope, $state, $http, $ionicPopup, $ionicHistory, alertService, ip, session, location, republic, redirect) {
    ...
    $scope.createRepublic = function (data) {
      if (data === undefined || data['name'] === undefined || data['locationKey'] === undefined) {
        ...
        $http.post(ip + '/createRepublic', data).success(function (response) {
    ...
    $scope.getRepublics = function () {
      ...
      $http.get(ip + '/getRepublicsById/' + idUsu).success(function (response) {
        var dado = angular.toJson(response);
        var obj = jQuery.parseJSON(dado);
    ...
    $scope.updateRepublic = function (data) {
      if (data === undefined || data['keyRep'] === undefined) {
        ...
        var data = {
          "name": name,
          "key_locat": keyLocatRep,
          "id_usu": idUsu,
          "id_rep": idRep
        };

        $http.put(ip + '/updateRepublic', data).success(function (response) {
          delete $scope.data;
          delete $scope.name;
          delete $scope.locationKey;
    ...
    $scope.deleteRepublic = function (data) {
      ...
      confirmPopup.then(function (res) {
        if (res) {
          ...
          $http.delete(ip + '/deleteRepublic/' + idRep + '/' + idUsu).success(function (response) {
  ...
  .controller('roomCtrl', function ($scope, $state, $http, alertService, ip, redirect, room) {
    ...
    //universidades
    $scope.getUniversities = function () {
      $http.get(ip + '/getUnivertisyKeys/').success(function (response) {
        var dado = angular.toJson(response);
        var obj = jQuery.parseJSON(dado);
    ...
    //republica
    $scope.getRepublics = function () {
      $http.get(ip + '/getRepublicKeys/').success(function (response) {
        var dado = angular.toJson(response);
        var obj = jQuery.parseJSON(dado);
    ...
    $scope.createRoom = function (data) {
      if (data === undefined || data['locationKey'] === undefined ||
        ...
        var data = {
          "locat_key": $scope.data.locationKey,
          "university_key": $scope.data.universityKey,
          "republic_key": republicKey,
        ...
        $http.post(ip + '/createRoom', data).success(function (response) {
    ...
    $scope.getRoomsByUser = function () {
      ...
      $http.get(ip + '/getRoomsByUser/' + idUsu).success(function (response) {
        var dado = angular.toJson(response);
        var obj = jQuery.parseJSON(dado);
        var rooms = obj["rooms"];
        if (rooms !== null) {
    ...
    $scope.updateRoom = function (data) {
      ...
      if (desc === undefined) {
        desc = window.localStorage['description'];
      }
      if (title === undefined) {
        title = window.localStorage['title'];
      }
      if (universityKey === undefined) {
        universityKey = window.localStorage['key_uni_room'];
      }
      if (republicKey === undefined) {
        republicKey = window.localStorage['key_rep_room'];
      }
      if (locationKey === undefined) {
        locationKey = window.localStorage['key_locat_room'];
      }
      if (price === undefined) {
      ...
      $http.put(ip + '/updateRoom', data).success(function (response) {
    ...
    $scope.deleteRoom = function (data) {
      var idRoom = window.localStorage['id_room'];
      var idUsu = window.localStorage['id_usu'];
      $http.delete(ip + '/deleteRoom/' + idRoom + "/" + idUsu).success(function (response) {
