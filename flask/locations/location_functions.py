...
class Location():
    ...
    def create_location(self, city_locat, state_locat, adress_locat, number_locat, id_usu):
        try:
    ...
    def update_location(self, city_locat, state_locat, address_locat, number_locat, id_locat, id_usu):
        try:
            cursor = self.base.get_cursor()
            conn = self.base.get_conn()
